(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".export__slider")) {
                const thumbsSwiper = new core(".export__slider", {
                ...
                if (document.querySelector(".thumbs__slider")) new core(".thumbs__slider", {
                    modules: [ Navigation, Autoplay, Thumb, Pagination ],
                    observer: true,
                    observeParents: true,
                    watchOverflow: true,
                    slidesPerView: 1,
        ...
        if (document.querySelector("#particles-js")) particlesJS("particles-js", {
            particles: {
                number: {
                    value: 150,
                    density: {
